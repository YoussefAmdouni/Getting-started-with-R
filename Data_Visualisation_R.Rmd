...
1- Data: dataframe we want to explore 
2- Aesthetics: specify features we want to plot 
3- Geometries: function to represent data points (histogram, barplot, ...) 
4- Facets: allow us to put multiple plots on a single canvas  
5- Statistics: a statistical transformation performs some useful statistical summary
6- Coordinates: deals with plot axis  
7- Theme: add a theme to our plot to affect things such as coloring background
